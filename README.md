...
Ảnh gốc được giới hạn 20 MB, mỗi lát OCR không vượt quá 7,5 MB và máy chủ vẫn giới hạn payload 12 MB. Endpoint OCR yêu cầu đăng nhập, không nhận Gemini API key từ trình duyệt và không lưu ảnh gốc. Ảnh chỉ là dữ liệu đầu vào tạm thời; hệ thống chỉ lưu các số liệu chuyến đã được người dùng duyệt. Nút **Chụp bảng** trên thanh công cụ tải xuống ảnh PNG của bảng dữ liệu đang hiển thị, gồm tiêu đề, các dòng trên trang hiện tại và dòng tổng cộng của tập dữ liệu đang lọc.
